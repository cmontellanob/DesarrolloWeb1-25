...
<?php if($_SESSION['nivel']==1){?>
 <a href="javascript:cargarContenido('forminsertar.php')"> Insertar</a>
 <?php } ?>
...
<table style="border-collapse: collapse" border="1" >
 ...
 while($row=mysqli_fetch_array($resultado)){
    ...
    <tr>
        ...
        <?php if($_SESSION['nivel']==1){?>
        <td><a href="javascript:editar('<?php echo $row['id'];?>')">Editar</a>  <a href="javascript:eliminar('<?php echo $row['id'];?>')">Eliminar</a> </td>
        <?php } ?>
    </tr>
    <?php } ?>
 </table>
<ul style="display: flex; list-style: none; gap=5px">
<li style="width: 10px;margin:5px" ><a href="javascript:cargarPagina(1,'<?php echo $buscar;?>','<?php echo $orden;?>','<?php echo $asente;?>')">&lt&lt</a></li>  
  <li style="width: 10px;margin:5px" ><a href="javascript:cargarPagina(<?php echo $pagina-1;?>,'<?php echo $buscar;?>','<?php echo $orden;?>', '<?php echo $asente;?>')">&lt </a></li>  
<?php for($i=1;$i<=$nropaginas;$i++){?>
    <li style="width: 10px;margin:5px"><a href="javascript:cargarPagina(<?php echo $i;?>,'<?php echo $buscar;?>','<?php echo $orden;?>', '<?php echo $asente;?>')"><?php echo $i;?></a></li>
<?php } ?>
<li style="width: 10px;margin:5px" ><a href="javascript:cargarPagina(<?php echo $pagina+1;?>,'<?php echo $buscar;?>','<?php echo $orden;?>', '<?php echo $asente;?>')">&gt </a></li>  
<li style="width: 10px;margin:5px" ><a href="javascript:cargarPagina(<?php echo $nropaginas;?>,'<?php echo $buscar;?>','<?php echo $orden;?>', '<?php echo $asente;?>')">&gt&gt </a></li>  
</ul>
